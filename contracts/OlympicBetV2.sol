...
contract OlympicBetV2 {
    ...
    // Withdraw GAS when nobody win a event
    function withdrawGAS(uint256 ammount) public onlyOwner {
        require(ammount < address(this).balance, "Not enough GAS to withdraw");
